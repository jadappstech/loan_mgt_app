...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/bootstrap-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:07:44 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
			...
			<nav class="sidebar-wrapper">
				...
				<div class="sidebar-tabs">
					...
					<div class="nav" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link active" id="graphs-tab" data-bs-toggle="tab" href="#tab-graphs" role="tab" aria-controls="tab-graphs" aria-selected="true">
					...
					<div class="tab-content">
						...
						<!-- Graphs tab -->
						<div class="tab-pane fade show active" id="tab-graphs" role="tabpanel" aria-labelledby="graphs-tab">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="bootstrap-tables.html" class="current-page">Bootstrap Tables</a>
                                        </li>
                                        <li>
			...
			************* -->
			<div class="main-container">
				...
				<div class="content-wrapper-scroll">
									...
									<div class="card-body">
										<div class="table-responsive">
											<table class="table table-bordered m-0">
												...
												<tbody>
													<tr>
														<td><img src="img/flags/1x1/hk.svg" class="flag-img" alt="Hong Kong">Hong Kong</td>
													...
													<tr>
														<td><img src="img/flags/1x1/au.svg" class="flag-img" alt="Australia">Australia</td>
													...
													<tr>
														<td><img src="img/flags/1x1/tz.svg" class="flag-img" alt="Tanzania">Tanzania</td>
													...
													<tr>
														<td><img src="img/flags/1x1/ru.svg" class="flag-img" alt="Russia">Russia</td>
													...
													<tr>
														<td><img src="img/flags/1x1/de.svg" class="flag-img" alt="Germany">Germany</td>
												...
												<tfoot>
													<tr>
														<td colspan="5" class="text-center">Data retrieved from <a href="#" class="link">UniPro</a> and <a href="#" class="link">UniPro</a>.</td>
													</tr>
												</tfoot>
											</table>
										</div>
					...
					<!-- App Footer start -->
					<div class="app-footer">© Uni Pro Admin 2020</div>
					<!-- App footer end -->
...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/bootstrap-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:07:46 GMT -->
</html>