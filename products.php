...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/products.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:20 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
						...
						<div class="tab-pane fade show active" id="tab-product" role="tabpanel" aria-labelledby="product-tab">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										<li>
											<a href="products.html" class="current-page">Products Grid</a>
										</li>
										<li>
						...
						<div class="row gutters">
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
								<div class="product-card">
									<img class="product-card-img-top" src="img/products/camera.jpg" alt="Card image cap">
									<div class="product-card-body">
										<h5 class="product-title">Camera</h5>
										<div class="product-price">
											<span class="disount-price">$550</span>
											<span class="actucal-price">$600</span>
											<span class="off-price">10% Off</span>
										</div>
										<div class="product-rating">
											<div class="rate2 rating-stars"></div>
											<div class="total-ratings">5529</div>
										</div>
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
								<div class="product-card">
									<img class="product-card-img-top" src="img/products/pencils.jpg" alt="Card image cap">
									<div class="product-card-body">
										<h5 class="product-title">Pencils</h5>
										<div class="product-price">
											<span class="disount-price">$210</span>
											<span class="actucal-price">$300</span>
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
								<div class="product-card">
									<img class="product-card-img-top" src="img/products/drone.jpg" alt="Card image cap">
									<div class="product-card-body">
										<h5 class="product-title">Drone</h5>
										<div class="product-price">
											<span class="disount-price">$950</span>
											<span class="actucal-price">$1250</span>
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
								<div class="product-card">
									<img class="product-card-img-top" src="img/products/bag.jpg" alt="Card image cap">
									<div class="product-card-body">
										<h5 class="product-title">Bag</h5>
										<div class="product-price">
											<span class="disount-price">$275</span>
											<span class="actucal-price">$325</span>
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
								<div class="product-card">
									<img class="product-card-img-top" src="img/products/toy.jpg" alt="Card image cap">
									<div class="product-card-body">
										<h5 class="product-title">Dinosaur</h5>
										<div class="product-price">
											<span class="disount-price">$275</span>
											<span class="actucal-price">$325</span>
											<span class="off-price">33% Off</span>
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
								<div class="product-card">
									<img class="product-card-img-top" src="img/products/ring.jpg" alt="Card image cap">
									<div class="product-card-body">
										<h5 class="product-title">Ring</h5>
										<div class="product-price">
											<span class="disount-price">$400</span>
											<span class="actucal-price">$800</span>
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
								<div class="product-card">
									<img class="product-card-img-top" src="img/products/clock.jpg" alt="Card image cap">
									<div class="product-card-body">
										<h5 class="product-title">Clock</h5>
										<div class="product-price">
											<span class="disount-price">$599</span>
											<span class="actucal-price">$999</span>
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
								<div class="product-card">
									<img class="product-card-img-top" src="img/products/shoes.jpg" alt="Card image cap">
									<div class="product-card-body">
										<h5 class="product-title">Shoes</h5>
										<div class="product-price">
											<span class="disount-price">$350</span>
											<span class="actucal-price">$750</span>
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
								<div class="product-card">
									<img class="product-card-img-top" src="img/products/shirt.jpg" alt="Card image cap">
									<div class="product-card-body">
										<h5 class="product-title">Shirt</h5>
										<div class="product-price">
											<span class="disount-price">$210</span>
											<span class="actucal-price">$250</span>
											<span class="off-price">10% Off</span>
										</div>
										<div class="product-rating">
											<div class="rate3 rating-stars"></div>
...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/products.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:21 GMT -->
</html>