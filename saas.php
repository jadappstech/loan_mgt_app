...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/saas.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:05:59 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
	...
	<body>
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="saas.html" class="current-page">Saas</a>
										</li>
										<li>
								...
								<div class="card h-380">
									...
									<div class="card-body">
										<ul class="tickets-container">
											...
											<li class="mb-0">
												<img src="img/user18.png" class="avatar" alt="Avatar" />
												<div class="ticket-details">
													<h6>Kiyara</h6>
								...
								<div class="card h-380">
									...
									<div class="card-body">
										<ul class="customer-rating">
											<li class="clearfix">
												<div class="customer">
													<img src="img/user2.png" alt="FlaminGo Admin">
												</div>
											...
											<li class="clearfix">
												<div class="customer">
													<img src="img/user3.png" alt="FlaminGo Admin">
												</div>
												<div class="customer-review">
		...
		************* -->
		...
		<script src="vendor/apex/custom/saas/sales.js"></script>
		<script src="vendor/apex/custom/saas/revenue.js"></script>
...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/saas.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:02 GMT -->
</html>