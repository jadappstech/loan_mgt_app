...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/forms-date-time-picker.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:07:01 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8" />
		<meta
		...
		************ -->
		...
		<link
			rel="stylesheet"
			href="vendor/search-filter/custom-search-filter.css"
		/>
				...
				<div class="sidebar-tabs">
					...
					<div class="nav" role="tablist" aria-orientation="vertical">
						...
						<a
							...
							data-bs-toggle="tab"
							href="#tab-authentication"
							role="tab"
							aria-controls="tab-authentication"
							aria-selected="false"
						>
					...
					<div class="tab-content">
						...
						>
							...
							<div class="tab-pane-header">Dashboards</div>
						...
						>
							<!-- Tab content header start -->
							<div class="tab-pane-header">Forms</div>
							<!-- Tab content header end -->
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="forms-layout-four.php"
												>Select 2 Tags and Mask</a
											>
										</li>
										<li>
											<a href="forms-layout-five.php"
												>Horizontal Form Layout</a
											>
										</li>
										<li>
									...
									<ul>
										...
										<li>
											<a href="forms-checkbox-radio.php"
												>Checkbox &amp; Radios</a
											>
										</li>
										<li>
									...
									<ul>
										...
										<li>
											<a href="forms-date-time-picker.php" class="current-page"
												>Date Time Picker</a
											>
										</li>
										<li>
						...
						>
							<!-- Tab content header start -->
							<div class="tab-pane-header">Components</div>
							<!-- Tab content header end -->
						...
						>
							<!-- Tab content header start -->
							<div class="tab-pane-header">Graphs &amp; Tables</div>
							<!-- Tab content header end -->
						...
						>
							<!-- Tab content header start -->
							<div class="tab-pane-header">Authentication</div>
							<!-- Tab content header end -->
							...
							<div class="sidebar-actions">
								<div class="support-tile blue">
									<a href="pricing.php" class="btn btn-light m-auto"
										>Upgrade Account</a
									>
								</div>
							</div>
						...
						>
							<!-- Tab content header start -->
							<div class="tab-pane-header">Settings</div>
							<!-- Tab content header end -->
									...
									<div class="accordion" id="settingsAccordion">
											...
											>
												<div class="accordion-body">
													...
													<div class="field-wrapper">
														<input
															type="email"
															value="jeivxezer-lopexz@email.com"
														/>
										...
										<div class="accordion-item">
											<h2 class="accordion-header" id="chngPwd">
												<button
													...
													type="button"
													data-bs-toggle="collapse"
													data-bs-target="#chngPwdCollapse"
													aria-expanded="false"
										...
										<div class="accordion-item">
											...
											<div
												id="notiCollapse"
												class="accordion-collapse collapse"
												aria-labelledby="sidebarNotifications"
												data-bs-parent="#settingsAccordion"
											>
												<div class="accordion-body">
							...
							<div class="sidebar-actions">
								<div class="support-tile blue">
									<a href="account-settings.php" class="btn btn-light m-auto"
										>Advance Settings</a
									>
								</div>
							</div>
							...
							<div class="search-container">
								...
								<div class="cd-dropdown-wrapper">
									<a class="cd-dropdown-trigger" href="#0"
										...
										><span class="menu-text">Megamenu</span></a
									>
												...
												<ul class="cd-secondary-dropdown is-hidden">
													...
													<li class="has-children">
														...
														<ul class="is-hidden">
															...
															<li>
																<a href="layout-scroll-cards.php"
																	>Scroll Cards</a
																>
															</li>
														</ul>
											...
											<li class="has-children">
												...
												<ul class="cd-secondary-dropdown is-hidden">
													...
													<li class="has-children">
														...
														<ul class="is-hidden">
															<li>
																<a href="calendar-daygrid-view.php"
																	>Daygrid View</a
																>
															</li>
															<li>
															...
															<li>
																<a href="calendar-external-dragging.php"
																	>Draggable</a
																>
															</li>
															<li>
																<a href="calendar-google-view.php"
																	>Google View</a
																>
															</li>
															<li>
																<a href="calendar-selectable.php"
																	>Selectable</a
																>
															</li>
														</ul>
											...
											<li class="has-children">
												...
												<ul class="cd-secondary-dropdown is-hidden">
													<li class="has-children">
														...
														<ul class="is-hidden">
															<li>
																<a href="forms-layout-one.php"
																	>Default Layout</a
																>
															</li>
															<li>
																<a href="forms-layout-two.php"
																	>Layout Sections</a
																>
															</li>
															<li>
																<a href="forms-layout-three.php"
																	>Simple Form Layout</a
																>
															</li>
															<li>
																<a href="forms-layout-four.php"
															...
															<li>
																<a href="forms-layout-six.php"
																	>Layout Six with Tabs</a
																>
															</li>
														</ul>
													</li>
													...
													<li class="has-children">
														...
														<ul class="is-hidden">
															...
															<li>
																<a href="forms-bs-select.php"
																	>Select 2 Dropdowns</a
																>
															</li>
															<li>
																<a href="forms-date-time-picker.php"
																	>Date Time Picker</a
																>
															</li>
															<li>
							...
							<ul class="header-actions">
								<li class="dropdown">
									...
									<div
										...
										aria-labelledby="taskss"
									>
										<div class="dropdown-menu-header">Tasks (7/10)</div>
											...
											<ul class="activity">
												<li class="activity-list">
													<div class="detail-info">
														...
														<p class="info">
															Messages accepted with attachments
														</p>
													</div>
												</li>
												<li class="activity-list danger">
													<div class="detail-info">
														<p class="date">Today</p>
														<p class="info">
															Send email notifications of subscriptions and
															deletions to list owner
														</p>
													</div>
												</li>
												<li class="activity-list success">
													<div class="detail-info">
														...
														<p class="info">
															Required change logs activity reports
														</p>
													</div>
												</li>
								...
								<li class="dropdown">
									...
									>
										<div class="dropdown-menu-header">Notifications (7)</div>
										<div class="customScroll">
									...
									>
										<div class="header-profile-actions">
											<a href="user-profile.php"
												><i class="icon-user1"></i>Profile</a
											>
											<a href="account-settings.php"
												><i class="icon-settings1"></i>Settings</a
											>
											<a href="forgot-password.php"
												><i class="icon-log-out1"></i>Logout</a
											>
										</div>
									</div>
								</li>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control custom-daterange"
														/>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control custom-daterange2"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-iso-week-numbers"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-time-24"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-time-seconds"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-range-week-numbers"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-range-iso-week-numbers"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-range-time"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-range-time-24"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
													...
													<div class="field-placeholder">
														Datepicker Range 24 Hours Time
													</div>
												</div>
												<!-- Field wrapper end -->
											</div>
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-range-right"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-range-left"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-range-top-right"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="field-wrapper">
													<div class="input-group">
														<input
															type="text"
															class="form-control datepicker-range-top-left"
														/>
														<span class="input-group-text">
															<i class="icon-calendar1"></i>
														</span>
