...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/layout-full-screen.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:10 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									...
									<ul>
										...
										<li>
											<a href="layout-full-screen.html" class="current-page">Full Screen</a>
										</li>
										<li>
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-9">
							...
							<div class="search-container">
								...
								<a href="index-2.html" class="logo">
									<img src="img/logo.svg" alt="Uni Pro Admin Dashboard">
								</a>
								<!-- Logo end -->
