...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/layout-bradcrumb.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:11 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									...
									<ul>
										...
										<li>
											<a href="layout-bradcrumb.php" class="current-page">Breadcrumbs</a>
										</li>
										<li>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                          ...
                                          <li class="breadcrumb-item"><a href="index-2.php">Dashboards</a></li>
