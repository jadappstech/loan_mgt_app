...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/create-invoice.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:42 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="create-invoice.php" class="current-page">Create Invoice</a>
										</li>
										<li>
							...
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="card">
									<div class="card-header-lg">
										...
										<div class="text-end">
											<a href="view-invoice.php" class="btn btn-light">View Invoice</a>
										</div>
									</div>
									<div class="card-body">
