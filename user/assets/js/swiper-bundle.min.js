...
!(function (e, t) {
  ...
  function f(e) {
    return "undefined" != typeof window && void 0 !== window.phpElement ? e instanceof HTMLElement : e && (1 === e.nodeType || 11 === e.nodeType);
  }
  function g() {
  ...
  const re = [
    ...
    function (e) {
      ...
      function p() {
        ...
        "custom" === s.type && s.renderCustom ? (r.php(s.renderCustom(t, p + 1, u)), i("paginationRender", r[0])) : i("paginationUpdate", r[0]), t.params.watchOverflow && t.enabled && r[t.isLocked ? "addClass" : "removeClass"](s.lockClass);
      }
      function u() {
        ...
        if ("bullets" === e.type) {
          ...
          a.php(r), (t.pagination.bullets = a.find(U(e.bulletClass)));
        }
        "fraction" === e.type && ((r = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span class="${e.currentClass}"></span> / <span class="${e.totalClass}"></span>`), a.php(r)), "progressbar" === e.type && ((r = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : `<span class="${e.progressbarFillClass}"></span>`), a.php(r)), "custom" !== e.type && i("paginationRender", t.pagination.$el[0]);
      }
      function h() {
