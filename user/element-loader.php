...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/element-loader.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:48 GMT -->
<head>
...
<body>
    ...
    <section class="section-b-space">
        <div class="custom-container">
            ...
            <ul class="element-list d-flex">
                <li>
                    <div class="spinner-grow theme-color" role="status">
                        <span class="visually-hidden">Loading...</span>
                    </div>
                </li>
                <li>
