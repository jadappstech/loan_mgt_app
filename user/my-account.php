...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/my-account.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:45 GMT -->
<head>
  ...
  <section class="section-b-space">
    <div class="custom-container">
      ...
      <form class="auth-form pt-0 mt-3" target="_blank">
        ...
        <a href="profile.php" class="btn theme-btn w-100">Update</a>
      </form>
    </div>
  </section>
