...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/add-card.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:41 GMT -->
<head>
...
<body class="auth-body">
  ...
  <form class="auth-form" target="_blank">
    <div class="custom-container">
      ...
      <a href="add-card-details.php" class="btn btn-link theme-color mt-3">or Add manually card details</a>
      <a href="add-card-details.php" class="btn theme-btn w-100">Continue</a>
      <a href="add-card-details.php" class="btn btn-link mt-3">Skip</a>
    </div>
  </form>
  <!-- login section start -->
