...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/add-card-pin.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:41 GMT -->
<head>
...
<body class="auth-body">
  ...
  <div class="auth-header">
    ...
    <img class="img-fluid img1" src="assets/images/authentication/10.svg" alt="v1" />
  ...
  <form class="auth-form" target="_blank">
    <div class="custom-container">
      ...
      <a href="successfully-signin.php" class="btn theme-btn w-100">Save</a>
    </div>
  </form>
  <!-- login section start -->
