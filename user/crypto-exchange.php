...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/crypto-exchange.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:37 GMT -->
<head>
    ...
    <div class="custom-container">
      <div class="currency-transfer">
        ...
        <div class="transfer-btn">
          <div class="custom-container">
            <a href="crypto.php" class="btn theme-btn sub-btn mt-3 w-100">Exchange now</a>
          </div>
        </div>
      </div>
    </div>
