...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/element-file-upload.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:48 GMT -->
<head>
...
<body>
    ...
    <section class="section-b-space">
        <div class="custom-container">
            <div class="app-title">
                <h2>Upload Card Photo</h2>
            </div>

            <form class="auth-form m-0" target="_blank">
                <div class="custom-container">
