...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/element-bottom-menu.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:48 GMT -->
<head>
...
<body>
    ...
    <!-- bottom menu section starts -->
    <section class="section-b-space">
        <div class="custom-container">
            <div class="title mb-3">
                <h2>Theme</h2>
            </div>
            <div class="navbar-menu elements-navbar position-relative mt-5">
            ...
            <div class="title mt-5 mb-3">
                <h2>Without Highlight </h2>
            </div>
            <div class="navbar-menu elements-navbar without-hightight position-relative">
                <div class="scanner-bg">
                    <div class="scanner-btn">
                        <img class="img-fluid" src="assets/images/svg/scan.svg" alt="scan" />
                    </div>
