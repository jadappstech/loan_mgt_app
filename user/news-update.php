...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/news-update.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:30 GMT -->
<head>
      ...
      <div class="row gy-3">
        ...
        <div class="col-12">
          <div class="news-update-box">
            <div class="d-flex align-items-center gap-3">
              <a href="news-update-details.php">
                <img class="img-fluid news-update-image" src="assets/images/4.jpg" alt="img2" />
              </a>
              <div class="news-update-content">
                <a href="news-update-details.php">
                  <h3>Rules you need to know in business</h3>
                </a>
                <div class="news-writer">
                  <h6>28 Apr, 2022</h6>
                  <h6>-Swidern</h6>
        ...
        <div class="col-12">
          <div class="news-update-box">
            <div class="d-flex align-items-center gap-3">
              <a href="news-update-details.php">
                <img class="img-fluid news-update-image" src="assets/images/5.jpg" alt="img3" />
              </a>
              <div class="news-update-content">
                <a href="news-update-details.php">
                  <h3>Follow the financial agenda with...</h3>
                </a>
                <div class="news-writer">
                  <h6>18 Apr, 23</h6>
                  <h6>-Merion</h6>
...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/news-update.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:31 GMT -->
</html>