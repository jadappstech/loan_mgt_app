...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:06:13 GMT -->
<head>
...
<body>
  ...
  <div class="onboarding-loader" id="onboardingLoader">
    <div class="rocket-img">
      <img class="rocket" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500"
        src="assets/images/svg/rocket.svg" alt="rocket">
    </div>
    <div class="flash-img">
      <img class="flash" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800"
        src="assets/images/svg/flash.svg" alt="flash">
    </div>
    <div class="logo-img">
      <img class="img-fluid" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="1000"
  ...
  <section class="onboarding-section highlight se" id="onboardingBody">
    <div class="swiper onboarding">
      <div class="swiper-wrapper">
          ...
          <div class="custom-container">
            ...
            <div class="d-flex justify-content-between align-items-center pb-3">
              ...
              <div class="onboarding-next">
                <img class="img-fluid arrow" src="assets/images/svg/arrow-white.svg" alt="arrow">
              </div>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="poster-wapper">
            <div class="poster-box-chain poster-box-chain1" data-aos="fade-down" data-aos-duration="1000"
              data-aos-delay="500">
              <span class="left-chain"></span>
              <span class="right-chain"></span>
            </div>
  ...
  <script src="assets/js/init-aos.js"></script>
...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:06:30 GMT -->
</html>