...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/element-carousel.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:48 GMT -->
<head>
                            ...
                            <a href="coin-details.php">
                                <div class="d-flex align-items-center gap-2 pb-3">
                                    <div class="portfolio-img">
                                        <img class="img-fluid img" src="assets/images/svg/bitcoins.svg"
                                            alt="bitcoins" />
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="portfolio-box">
                            <a href="coin-details.php">
                                <div class="d-flex align-items-center gap-2 pb-3">
                                    <div class="portfolio-img">
                                        <img class="img-fluid img" src="assets/images/svg/ethereum.svg"
                                            alt="ethereum" />
                                    </div>
                                    <div class="portfolio-details">
                                        <div>
