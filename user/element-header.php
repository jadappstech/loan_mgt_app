...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/element-header.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:48 GMT -->
<head>
    ...
    <section class="section-b-space">
        <div class="custom-container">
            ...
            <div class="app-title mt-5 mb-3">
                <h2>Pages Header With Option</h2>
            </div>
            <div class="header-panel">
                <a class="sidebar-btn" data-bs-toggle="offcanvas" data-bs-target="#offcanvasLeft">
                    <i class="menu-icon" data-feather="menu"></i>
            ...
            <div class="app-title mt-5 mb-3">
                <h2>Pages Header Without Option</h2>
            </div>
            <div class="header-panel">
                <a class="sidebar-btn" data-bs-toggle="offcanvas" data-bs-target="#offcanvasLeft">
                    <i class="icon dark-text" data-feather="arrow-left"></i>
                </a>
                <h2>Home</h2>
