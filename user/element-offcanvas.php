...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/element-offcanvas.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:48 GMT -->
<head>
...
<body>
    ...
    <section class="section-b-space">
        <div class="custom-container">
            ...
            <button class="btn theme-btn mt-4 mb-3 w-100" type="button" data-bs-toggle="offcanvas"
                data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">Toggle Top Offcanvas
            </button>

            <div class="offcanvas element-offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop"
            ...
            <div class="app-title mt-4">
                <h2>Right Offcanvas</h2>
            </div>

            <button class="btn theme-btn mt-4 mb-3 w-100" type="button" data-bs-toggle="offcanvas"
                data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Toggle Right Offcanvas</button>

            <div class="offcanvas element-offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
            ...
            <div class="offcanvas element-offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom"
            ...
            <div class="app-title mt-4">
                <h2>Left Offcanvas</h2>
            </div>

            <button class="btn theme-btn mt-4 mb-3 w-100" type="button" data-bs-toggle="offcanvas"
                data-bs-target="#offcanvasleft" aria-controls="offcanvasleft">Toggle Left Offcanvas</button>

            <div class="offcanvas element-offcanvas offcanvas-start" tabindex="-1" id="offcanvasleft"
