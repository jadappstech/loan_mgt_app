...
<!-- Mirrored from themes.pixelstrap.net/pwa/mpay/crypto-request.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 05:08:37 GMT -->
<head>
    ...
    <div class="custom-container">
      <div class="currency-transfer">
        <form class="auth-form crypto-form" target="_blank">
          <div class="form-group">
            ...
            <div class="d-flex gap-2">
              <div class="dropdown">
                <a class="dropdown-toggle" role="button" data-bs-toggle="dropdown">Select request payment</a>
            ...
            <div class="d-flex align-items-center justify-content-between mt-2">
              ...
              <h5 class="theme-color fw-normal mb-0">$1.2563 USD</h5>
            </div>
          </div>

          <div class="form-group">
            <label for="inputname" class="form-label">Contact</label>
        ...
        <div class="transfer-btn">
          <div class="custom-container">
            <a href="#request" class="btn theme-btn sub-btn  w-100" data-bs-toggle="modal">Sent request</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <h3>Your request was submitted to Seema Williams successfully.</h3>
        </div>
