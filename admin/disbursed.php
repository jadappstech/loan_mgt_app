			...
			<div class="main-container">
               ...
               <!-- Your code goes in here...-->
								<!--<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="" style="width: 80%; margin: auto; height: 75vh; border-radius:25px; background-color:#292c62;">
										<span style="font-size:25px;" >Your Loan Is Being</span> <br><br> Disbursed</span>
										<div style="width: 200px; height: 120px; background-color: #f3f3f3; position: relative; border: 2px solid #ccc;">
								-->			
...
class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
  ...
  <div style="width: 100%; height: 45%; background-color: green; position: absolute; top: 0; 
