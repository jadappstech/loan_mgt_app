...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/layout-tile-menu.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:08 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul class="tile-menu">
										...
										<li>
											<a href="analytics.php"><i class="icon-bar-chart"></i> Analytics</a>
										</li>
										<li>
											<a href="sales.php"><i class="icon-shopping-bag1"></i> Sales</a>
										</li>
										<li>
											<a href="reports.php"><i class="icon-layers2"></i> Reports</a>
										</li>
										<li>
											<a href="saas.php"><i class="icon-triangle"></i> Saas</a>
										</li>
										<li>
											<a href="consulting.php"><i class="icon-calendar1"></i> Consulting</a>
										</li>
									</ul>
									<ul class="tile-menu">
										<li class="list-heading">Layouts</li>
										<li>
											<a href="starter-page.php"><i class="icon-layout"></i> Starter Page</a>
										</li>
                                        <li>
											<a href="layout-tile-menu.php" class="current-page"><i class="icon-grid"></i> Tile Menu</a>
										</li>
										<li>
											<a href="layout-hover-tabs.php"><i class="icon-document-landscape"></i> Hover Tabs</a>
										</li>
										<li>
											<a href="layout-full-screen.php"><i class="icon-maximize"></i>Full Screen</a>
										</li>
										<li>
											<a href="layout-search.php"><i class="icon-search1"></i>Global Search</a>
										</li>
										<li>
											<a href="layout-megamenu.php"><i class="icon-server"></i>Megamenu</a>
										</li>
										<li>
											<a href="layout-bradcrumb.php"><i class="icon-hard-drive"></i>Breadcrumbs</a>
										</li>
										<li>
											<a href="layout-scroll-cards.php"><i class="icon-sliders"></i>Scroll Cards</a>
										</li>
									</ul>
								</div>
							</div>
