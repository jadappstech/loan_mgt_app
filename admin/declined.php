...
<head>
  ...
  <!-- Bottom Part of Envelope -->
	  ...
	  <span style="font-size:25px; color:gray;">We Are Sorry To Inform You That Your Loan Application Has Been</span><br> 
		<span style="font-size:40px; font-weight:700; color: black;" >Declined</span>
	</div>
  
  <!-- Flipped Elliptical Flap -->
  <div style="width: 100%; height: 45%; background: linear-gradient(95deg, #e34c3c, #c0072b); position: absolute; top: 0; 
