...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/timeline.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:58 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="timeline.html" class="current-page">Timeline</a>
										</li>
										<li>
												...
												<div class="timeline">
													<div class="timeline-row">
														<div class="timeline-time">
															7:45PM<small>Jan 21</small>
														</div>
														<div class="timeline-content">
															<i class="icon-attachment"></i>
															<h4>Admin theme!</h4>
															<p>Meow Admin Dashboard contains C3 graphs, flot graphs, data tables, calendar, drag &amp; drop and ion slider.</p>
															<div class="thumbs">
																<div class="row gutters">
																	<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
																		<img class="img-fluid rounded" src="img/products/bag.jpg" alt="Meow Admin" />
																	</div>
																	<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
																		<img class="img-fluid rounded" src="img/products/camera.jpg" alt="Meow Admin" />
																	</div>
																	<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
																		<img class="img-fluid rounded" src="img/products/clock.jpg" alt="Meow Admin" />
																	</div>
																</div>
															</div>
															<div class="">
													...
													<div class="timeline-row">
														<div class="timeline-time">
															8:00 AM<small>Jan 18</small>
														</div>
														<div class="timeline-content">
															<i class="icon-code"></i>
															<h4>Admin Dashboard!</h4>
															<p>
																Meow Admin Dashboard contains C3 graphs, flot graphs, data tables, calendar.
															</p>
															<div class="thumbs">
																<div class="row gutters">
																	<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
																		<img class="img-fluid rounded" src="img/products/drone.jpg" alt="Meow Admin" />
																	</div>
																	<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
																		<img class="img-fluid rounded" src="img/products/clock.jpg" alt="Meow Admin" />
																	</div>
																	<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
																		<img class="img-fluid rounded" src="img/products/pencils.jpg" alt="Meow Admin" />
																	</div>
																</div>
															</div>
															<div class="">
													...
													<div class="timeline-row">
														...
														<div class="timeline-content">
															...
															<div>
																...
																<span class="badge">Documents List</span>
															</div>
														</div>
													</div>
													...
													<div class="timeline-row">
														<div class="timeline-time">
															5:24 PM<small>Jan 12</small>
														</div>
														<div class="timeline-content">
															<i class="icon-change_history"></i>
															<h4>Meow Dashboard</h4>
															<p class="no-margin">Meow Admin dashboard includes invoice, profile, tasks, gallery, projects, maintanence.</p>
															<div class="thumbs">
																<div class="row gutters">
																	<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
																		<img class="img-fluid rounded" src="img/products/shoes.jpg" alt="Meow Admin" />
																	</div>
																	<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
																		<img class="img-fluid rounded" src="img/products/ring.jpg" alt="Meow Admin" />
																	</div>
																	<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
																		<img class="img-fluid rounded" src="img/products/toy.jpg" alt="Meow Admin" />
																	</div>
																</div>
															</div>
															<div>
																<span class="badge">Analytics</span>
																<span class="badge">Contacts List</span>
															</div>
														</div>
													</div>
