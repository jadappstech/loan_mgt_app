...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/layout-hover-tabs.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:09 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									...
									<ul>
										...
										<li>
											<a href="hover-tabs.html" class="current-page">Hover Tabs</a>
										</li>
										<li>
							...
							<div class="col-xl-12">
								...
								<div class="card m-0">
									...
									<div class="card-body" style="min-height: calc(100vh - 185px);">
										...
										<img src="img/hover-on-tabs.svg" class="hover-tabs-img" alt="Hover Tabs" />
									</div>
								</div>
								<!-- Card end -->
                            </div>
...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/layout-hover-tabs.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:10 GMT -->
</html>