...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/custom-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:07:46 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="custom-tables.html" class="current-page">Custom Tables</a>
                                        </li>
                                        <li>
												...
												<tbody>
													<tr>
														<td>
															<div class="d-flex align-items-center">
																<div class="me-2">
																	<img src="img/user8.png" class="img-36" alt="Avatar">
																</div>
																<div >
																	<b>Braxten</b>
																	<div>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																<div class="me-2">
																	<img src="img/user5.png" class="img-36" alt="Avatar">
																</div>
																<div >
																	<b>Gelnn Maxx</b>
																	<div>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																<div class="me-2">
																	<img src="img/user18.png" class="img-36" alt="Avatar">
																</div>
																<div >
																	<b>Hayanshi Arora</b>
																	<div>
										...
										<div class="table-responsive">
											<table class="table table-bordered v-middle m-0">
												...
												<tbody>
													<tr>
														<td>USA</td>
														<td><span class="badge bg-info">358</span></td>
														<td>4.3 mins</td>
														<td>25 Millions</td>
														<td>$13,850.00</td>
														<td>USD 980</td>
													...
													<tr>
														<td>India</td>
														<td><span class="badge bg-success">562</span></td>
														<td>2.7 mins</td>
														<td>45 Millions</td>
														<td>$89,319.00</td>
														<td>USD 887</td>
													...
													<tr>
														<td>Australia</td>
														<td><span class="badge bg-danger">126</span></td>
														<td>1.8 mins</td>
														<td>3 Millions</td>
														<td>$65,800.00</td>
														<td>USD 685</td>
