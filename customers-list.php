...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/customers-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:29 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="customers-list.html" class="current-page">Customers</a>
										</li>
										<li>
										...
										<div class="table-responsive">
											<table id="copy-print-csv" class="table v-middle">
												...
												<tbody>
													<tr>
														<td>
															<img src="img/flags/1x1/br.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user5.png" class="media-avatar" alt="Customer">
													...
													<tr>
														<td>
															<img src="img/flags/1x1/ni.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user2.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Garrett Winters</a>
													  			<p>ID: #FLM00763</p>
													  		</div>
													  	</div>
													  </td>
													...
													<tr>
														<td>
															<img src="img/flags/1x1/za.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user8.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Cedric Kelly</a>
													  			<p>ID: #FLM00582</p>
													  		</div>
													  	</div>
													  </td>
													...
													<tr>
														<td>
															<img src="img/flags/1x1/eu.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user12.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Rhona Davidson</a>
													  			<p>ID: #FLM00554</p>
													  		</div>
													  	</div>
													  </td>
													...
													<tr>
														<td>
															<img src="img/flags/1x1/bv.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user19.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Quinn Flynn</a>
													  			<p>ID: #FLM00831</p>
													  		</div>
													  	</div>
													  </td>
													...
													<tr>
														<td>
															<img src="img/flags/1x1/se.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user16.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Paul Byrd</a>
													  			<p>ID: #FLM00831</p>
													  		</div>
													...
													<tr>
														<td>
															<img src="img/flags/1x1/in.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user13.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Gavin Joyce</a>
													  			<p>ID: #FLM00999</p>
													  		</div>
													  	</div>
													  </td>
													...
													<tr>
														<td>
															<img src="img/flags/1x1/hn.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user9.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Tiya Nixon</a>
													  			<p>ID: #FLM00987</p>
													  		</div>
													...
													<tr>
														<td>
															<img src="img/flags/1x1/au.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user6.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Garrett Winters</a>
													  			<p>ID: #FLM00323</p>
													  		</div>
													...
													<tr>
														<td>
															<img src="img/flags/1x1/ca.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user24.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Dai Rios</a>
													  			<p>ID: #FLM00333</p>
													  		</div>
													...
													<tr>
													  ...
													  <td>
													  	<div class="media-box">
													  		<img src="img/user4.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Cedric Kelly</a>
													  			<p>ID: #FLM00582</p>
													  		</div>
													...
													<tr>
														<td>
															<img src="img/flags/1x1/cw.svg" class="img-flag" alt="Country">
														</td>
													  <td>
													  	<div class="media-box">
													  		<img src="img/user14.png" class="media-avatar" alt="Customer">
													  		<div class="media-box-body">
													  			<a href="#">Rhona Davidson</a>
													  			<p>ID: #FLM00554</p>
													  		</div>
...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/customers-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:36 GMT -->
</html>