...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/accordions.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:07:08 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
						...
						<div class="tab-pane fade show active" id="tab-components" role="tabpanel" aria-labelledby="components-tab">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
                                        <li>
                                            <a href="accordions.html" class="current-page">Accordions</a>
                                        </li>
                                        <li>
