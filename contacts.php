...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/contacts.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:45 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="contacts.php" class="current-page">Contacts</a>
										</li>
										<li>
														...
														<div class="row gutters">
															<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
																<div id="dropzone-sm1" class="mb-3">
																	<form action="https://www.bootstrapget.com/upload" class="dropzone needsclick dz-clickable" id="demo-upload1">
															...
															<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12">
																<div class="row gutters">
																	<div class="col-6">
																		<!-- Field wrapper start -->
																		<div class="field-wrapper">
																			<input type="text" class="form-control" value="Braxten">
																			<div class="field-placeholder">Full Name</div>
																		</div>
																		<!-- Field wrapper end -->
																		<!-- Field wrapper start -->
																		<div class="field-wrapper">
																			<input type="text" class="form-control" value="+2 300-678-6789">
																			<div class="field-placeholder">Phone</div>
																		</div>
																		<!-- Field wrapper end -->
																	</div>
																	<div class="col-6">
																		<!-- Field wrapper start -->
																		<div class="field-wrapper">
																			<input type="text" class="form-control" value="braxten@meow.com">
																			<div class="field-placeholder">Email</div>
																		</div>
																		<!-- Field wrapper end -->																		
																		<!-- Field wrapper start -->
...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/contacts.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:46 GMT -->
</html>