...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/layout-tile-menu.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:08 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul class="tile-menu">
										...
										<li>
											<a href="analytics.html"><i class="icon-bar-chart"></i> Analytics</a>
										</li>
										<li>
											<a href="sales.html"><i class="icon-shopping-bag1"></i> Sales</a>
										</li>
										<li>
											<a href="reports.html"><i class="icon-layers2"></i> Reports</a>
										</li>
										<li>
											<a href="saas.html"><i class="icon-triangle"></i> Saas</a>
										</li>
										<li>
											<a href="consulting.html"><i class="icon-calendar1"></i> Consulting</a>
										</li>
									</ul>
									<ul class="tile-menu">
										...
										<li>
											<a href="layout-hover-tabs.html"><i class="icon-document-landscape"></i> Hover Tabs</a>
										</li>
										<li>
											<a href="layout-full-screen.html"><i class="icon-maximize"></i>Full Screen</a>
										</li>
										<li>
										...
										<li>
											<a href="layout-scroll-cards.html"><i class="icon-sliders"></i>Scroll Cards</a>
										</li>
									</ul>
								</div>
							</div>
