...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/faq.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:45 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="faq.php" class="current-page">Faq's</a>
										</li>
										<li>
						...
						<div class="row gutters">
							...
							<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
								<div class="submit-request-card">
									...
									<a href="chat.php" class="btn btn-info">Lets Chat</a>
								</div>
							</div>
						</div>
						<!-- Row end -->
