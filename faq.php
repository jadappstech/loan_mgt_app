...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:45 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="faq.html" class="current-page">Faq's</a>
										</li>
										<li>
					...
					<div class="content-wrapper">
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingThree">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        3. How much do I get from each sale?
                                                    </button>
                                                </h2>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingSix">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                                        6. How much do I get from each sale?
                                                    </button>
                                                </h2>
						...
						<div class="row gutters">
							<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
								<div class="submit-request-card">
									<div>
										...
										<p>Please submit a Ticket if you any further Queries.</p>
									</div>
									<button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#submitTicketModal">Submit a Ticket</button>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="submitTicketModalLabel">Submit Request</h5>
													...
													<form class="row gutters">
														<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
															...
															<div class="field-wrapper">
																...
																<div class="field-placeholder">Your Email</div>
															</div>
															<!-- Field wrapper end -->
															<!-- Field wrapper start -->
															<div class="field-wrapper">
							...
							<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
								<div class="submit-request-card">
									<div>
										<h5 class="text-info">Live Chat</h5>
										<p>Let us chat if you any further Queries or Queries.</p>
									</div>
									<a href="chat.html" class="btn btn-info">Lets Chat</a>
								</div>
							</div>
						</div>
						<!-- Row end -->
