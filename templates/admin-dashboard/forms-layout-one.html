...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/forms-layout-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:59 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="forms-layout-one.html" class="current-page">Default Layout</a>
										</li>
										<li>
