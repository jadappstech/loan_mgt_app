...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/invoices-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:18 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
						...
						<div class="tab-pane fade show active" id="tab-pages" role="tabpanel" aria-labelledby="pages-tab">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="invoices-list.html" class="current-page">Invoices List</a>
										</li>
										<li>
							...
							<div class="sidebar-actions">
								<div class="support-tile green">
									<i class="icon-pie-chart1"></i> 25 Invoices
								</div>
							</div>
							<!-- Sidebar actions ends -->
											...
											<table id="copy-print-csv" class="table v-middle">
												...
												<tbody>
													<tr>
													  	<td>
															<div class="media-box">
																<img src="img/user.png" class="media-avatar" alt="User">
																<div class="media-box-body">
																	<a href="#" class="text-truncate">Braxten Joe</a>
																</div>
															</div>
														</td>
														<td>Theode Lowe, #867 Sit Rd, New York 39531</td>
														<td class="text-info">$2500.00</td>
														<td>28/05/2021</td>
														<td>
															<a href="#" class="btn btn-info btn-sm">Request</a>
														</td>
													</tr>
													<tr>
														<td>
														  	<div class="media-box">
																<img src="img/user2.png" class="media-avatar" alt="User">
																<div class="media-box-body">
																	<a href="#" class="text-truncate">Lawrence Moreno</a>
																</div>
														  	</div>
														</td>
														<td>Forrest Ray, 191 Integer Rd, Coron Mexico 08219</td>
														<td class="text-info">$7209.00</td>
														<td>07/05/2021</td>
														<td>
															<a href="#" class="btn btn-info btn-sm">Request</a>
														</td>
												  	...
												  	<tr>
														<td>
															<div class="media-box">
																<img src="img/user5.png" class="media-avatar" alt="User">
																<div class="media-box-body">
																	<a href="#" class="text-truncate">Forrest Bay</a>
																</div>
															</div>
														</td>
														<td>Moreno, 990 Tortor Street, Santa Rosa MN 98804</td>
														<td class="text-info">$3105.00</td>
														<td>18/05/2021</td>
														<td>
															<a href="#" class="btn btn-info btn-sm">Request</a>
														</td>
													...
													<tr>
														<td>
															<div class="media-box">
																<img src="img/user7.png" class="media-avatar" alt="User">
																<div class="media-box-body">
																	<a href="#" class="text-truncate">Colby Bernard</a>
																</div>
															</div>
														</td>
														<td>Melvin Porter, 132 Curab, South Dakota 45149</td>
														<td class="text-info">$4150.00</td>
														<td>12/05/2021</td>
														<td>
															<a href="#" class="btn btn-info btn-sm">Request</a>
														</td>
													...
													<tr>
														<td>
															<div class="media-box">
																<img src="img/user9.png" class="media-avatar" alt="User">
																<div class="media-box-body">
																	<a href="#" class="text-truncate">Katelyn Cooper</a>
																</div>
															</div>
														</td>
														<td>Griffith Daniels, 6818 Eget St, Tacoma AL 92508</td>
														<td class="text-info">$1387.00</td>
														<td>23/05/2021</td>
														<td>
															<a href="#" class="btn btn-info btn-sm">Request</a>
														</td>
													...
													<tr>
														<td>
															<div class="media-box">
																<img src="img/user12.png" class="media-avatar" alt="User">
																<div class="media-box-body">
																	<a href="#" class="text-truncate">ordan Calderon</a>
																</div>
															</div>
														</td>
														<td>Anderson, 1964 Avenue, Bell Gardens Texas 87065</td>
														<td class="text-info">$6652.00</td>
														<td>22/05/2021</td>
														<td>
															<a href="#" class="btn btn-info btn-sm">Request</a>
														</td>
													...
													<tr>
														<td>
															<div class="media-box">
																<img src="img/user23.png" class="media-avatar" alt="User">
																<div class="media-box-body">
																	<a href="#" class="text-truncate">Pascale Patton</a>
																</div>
															</div>
														</td>
														<td>Ivor Delgado, Ap #310-1678, Santa Barbara MT 88317</td>
														<td class="text-info">$7673.00</td>
														<td>16/05/2021</td>
														<td>
															<a href="#" class="btn btn-info btn-sm">Request</a>
														</td>
													...
													<tr>
														<td>
															<div class="media-box">
																<img src="img/user14.png" class="media-avatar" alt="User">
																<div class="media-box-body">
																	<a href="#" class="text-truncate">Keegan Blair</a>
																</div>
															</div>
														</td>
														<td>Sade Higgins Ap #287-3260, Wilmington ot 05182</td>
														<td class="text-info">$8982.00</td>
														<td>29/05/2021</td>
														<td>
															<a href="#" class="btn btn-info btn-sm">Request</a>
														</td>
													...
													<tr>
														<td>
															<div class="media-box">
																<img src="img/user19.png" class="media-avatar" alt="User">
																<div class="media-box-body">
																	<a href="#" class="text-truncate">Nasim Strong</a>
																</div>
															</div>
														</td>
														<td>Daniel Malone, 2136 Adipiscing Av, Lima RI 93490</td>
														<td class="text-info">$4781.00</td>
														<td>11/05/2021</td>
														<td>
															<a href="#" class="btn btn-info btn-sm">Request</a>
														</td>
													...
													<tr>
														<td>
															<div class="media-box">
																<img src="img/user20.png" class="media-avatar" alt="User">
																<div class="media-box-body">
																	<a href="#" class="text-truncate">Tamara Howe</a>
																</div>
															</div>
														</td>
														<td>Elmo Lopez Ap #481-7473, South Carolina 28423</td>
														<td class="text-info">$5298.00</td>
														<td>10/05/2021</td>
														<td>
															<a href="#" class="btn btn-info btn-sm">Request</a>
														</td>
...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/invoices-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:20 GMT -->
</html>