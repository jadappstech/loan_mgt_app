...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/forms-layout-six.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:07:01 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="forms-layout-six.html" class="current-page">Layout Six with Tabs</a>
										</li>
									</ul>									
									<ul>
										...
										<div class="custom-tabs-container">
											...
											<div class="tab-content" id="myTabContent">
												...
												<div class="tab-pane fade" id="second" role="tabpanel" aria-labelledby="second-tab-label">
													<!-- Row start -->
													<div class="row gutters" id="second-tab-label">
														<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
															...
															<div class="field-wrapper">
																...
																<div class="field-placeholder">Person <span class="text-danger">*</span></div>
															</div>
															<!-- Field wrapper end -->
														...
														<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
															...
															<div class="field-wrapper">
																...
																<div class="field-placeholder">Website <span class="text-danger">*</span></div>
															</div>
															<!-- Field wrapper end -->
														...
														<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
															...
															<div class="field-wrapper">
																...
																<div class="field-placeholder">Information</div>
															</div>
															<!-- Field wrapper end -->
														...
														<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
															...
															<div class="field-wrapper">
																...
																<div class="field-placeholder">Pin</div>
															</div>
															<!-- Field wrapper end -->
														...
														<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
															...
															<div class="field-wrapper mt-2">
																<div class="checkbox-container">
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="checkbox" id="chcekEmail2" value="option1">
																		<label class="form-check-label" for="chcekEmail2">Email</label>
																	</div>
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="checkbox" id="checkSms2" value="option2">
																		<label class="form-check-label" for="checkSms2">SMS</label>
																	</div>
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="checkbox" id="checkPhone2" value="option3">
																		<label class="form-check-label" for="checkPhone2">Phone</label>
																	</div>
																	<div class="field-placeholder">Communication</div>
																</div>
															</div>
												...
												<div class="tab-pane fade" id="third" role="tabpanel" aria-labelledby="third-tab-label">
													<!-- Row start -->
													<div class="row gutters" id="third-tab-label">
														<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
														...
														<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
															...
															<div class="field-wrapper">
																...
																<div class="field-placeholder">Mail ID <span class="text-danger">*</span></div>
															</div>
															<!-- Field wrapper end -->
														...
														<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
															...
															<div class="field-wrapper mt-2">
																<div class="checkbox-container">
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="checkbox" id="chcekEmail3" value="option1">
																		<label class="form-check-label" for="chcekEmail3">Email</label>
																	</div>
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="checkbox" id="checkSms3" value="option2">
																		<label class="form-check-label" for="checkSms3">SMS</label>
																	</div>
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="checkbox" id="checkPhone3" value="option3">
																		<label class="form-check-label" for="checkPhone3">Phone</label>
																	</div>
																	<div class="field-placeholder">Communication</div>
																</div>
															</div>
											...
											<div class="form-actions-footer">
												<div class="text-end">
													...
													<button class="btn btn-primary ms-1">Save</button>
												</div>
											</div>
										</div>
