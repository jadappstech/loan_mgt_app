...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/gallery-tiles.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:46 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
                                        ...
                                        <li>
											<a href="gallery-tiles.html" class="current-page">Gallery Tiles</a>
                                        </li>
                                        <li>
                        ...
                        <div class="gallery-tiles">
                            ...
                            <div class="row g-0">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-12">
                                            <img src="img/realestate/img1.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                            <img src="img/realestate/img8.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
                                            <img src="img/realestate/img9.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
                                            <img src="img/realestate/img10.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
                                            <img src="img/realestate/img11.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                    </div>
                                    <!-- Row end -->
                                ...
                                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <img src="img/realestate/img5.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <img src="img/realestate/img2.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <img src="img/realestate/img3.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <img src="img/realestate/img4.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                    </div>
                                    <!-- Row end -->
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-12">
                                            <img src="img/realestate/img6.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <img src="img/realestate/img7.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                            <img src="img/realestate/img12.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                            <img src="img/realestate/img10.jpg" class="img-fluid" alt="BlueMoon Real Estate Admin">
                                        </div>
...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/gallery-tiles.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:55 GMT -->
</html>