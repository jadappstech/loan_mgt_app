...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/layout-slim-menu.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:06:09 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
								...
								<li class="default-sidebar-dropdown active">
									...
									<div class="default-sidebar-submenu">
										<ul>
											...
											<li>
												<a href="layout-slim-menu.php" class="current-page">Slim Sidebar</a>
											</li>
											<li>
