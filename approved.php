...
<head>
	...
	<body>
		...
		<div class="page-wrapper">
			...
			************* -->
			<div style="display:grid; justify-content:center; !important; padding-left:48px;" class="main-container">
				...
				<div class="content-wrapper-scroll">
					...
					<div class="content-wrapper">
															...
															<div style="display:flex; width: 100vh !important; height:75vh; justify-content:center;" class="task-types">
																	...
																	border-radius:25px; width:90vh; background-color: #34a335 !important; " class="badge bg-warning"><span style="font-size:25px; ">
																	<span style="font-size:45px;" > Congratulations </span> <br> <br><br><br><br>Your Loan As Been Approved</span>
																	</button>
