...
<!-- Mirrored from www.bootstrapget.com/demos/themeforest/unipro-admin-template/demos/01-design-blue/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Sep 2024 13:07:08 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
                                        ...
                                        <li>
                                            <a href="cards.html" class="current-page">Cards</a>
                                        </li>
                                        <li>
					...
					<div class="content-wrapper">
						...
						<div class="row">
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
								...
								<!-- Card start -->
								<div class="card">
									<img src="img/realestate/img1.jpg" class="card-img-top" alt="...">
									<div class="card-body">
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
								...
								<div class="card">									
									...
									<img src="img/realestate/img6.jpg" class="card-img-bottom" alt="...">
								</div>
								<!-- Card end -->
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
								...
								<!-- Card start -->
								<div class="card">
									<img src="img/realestate/img10.jpg" class="card-img-top" alt="...">
									<div class="card-body">
										<h5 class="card-title">Card Title</h5>
										<p class="mb-3 text-light">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
										<a href="#" class="btn btn-primary">Buy Now</a>
